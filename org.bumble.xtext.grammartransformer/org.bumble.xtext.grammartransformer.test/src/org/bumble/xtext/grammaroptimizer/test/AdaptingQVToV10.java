...
public class AdaptingQVToV10 {
	@Test
	public void testAdaptingQVToV10() {
		GrammarTransformer go = new GrammarTransformer();
		
		// read text from file
		String input = FileHelper.getFileText("QVToV10.txt", true);
		...
		go.removeAttribute("VarParameter", "bindParameter");
...
//		go.convert1toStarTo1("MappingBody", "endSection");
		go.moveLine("MappingBody", "population_section", "endSection", true);
		...
		//FileHelper.setFileText("Test_QVToV10.txt", actualOutput);
		String expectOutput = FileHelper.getFileText("Test_QVToV10.txt", false);
