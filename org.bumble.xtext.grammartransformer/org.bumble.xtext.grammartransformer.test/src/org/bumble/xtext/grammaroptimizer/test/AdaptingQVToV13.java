...
public class AdaptingQVToV13 {
	@Test
	public void testAdaptingQVToV13() {
		GrammarTransformer go = new GrammarTransformer();
		
		// read text from file
		String input = FileHelper.getFileText("QVToV13.txt", true);
...
//		go.convert1toStarTo1("MappingBody", "endSection");
		...
		//FileHelper.setFileText("Test_QVToV13.txt", actualOutput);
		String expectOutput = FileHelper.getFileText("Test_QVToV13.txt", false);
