...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Symbol To Line</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.AddSymbolToLineImpl#getNewSymbol <em>New Symbol</em>}</li>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.AddSymbolToLineImpl#isIsFront <em>Is Front</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddSymbolToLineImpl extends OptimizationRuleImpl implements AddSymbolToLine {
	/**
	...
	protected EClass eStaticClass() {
		return OptimizationrulePackage.Literals.ADD_SYMBOL_TO_LINE;
	}
	...
	public void setNewSymbol(String newNewSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimizationrulePackage.ADD_SYMBOL_TO_LINE__NEW_SYMBOL, oldNewSymbol, newSymbol));
	}
	...
	public void setIsFront(boolean newIsFront) {
		...
		isFront = newIsFront;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimizationrulePackage.ADD_SYMBOL_TO_LINE__IS_FRONT, oldIsFront, isFront));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OptimizationrulePackage.ADD_SYMBOL_TO_LINE__NEW_SYMBOL:
				return getNewSymbol();
			case OptimizationrulePackage.ADD_SYMBOL_TO_LINE__IS_FRONT:
				return isIsFront();
		}
