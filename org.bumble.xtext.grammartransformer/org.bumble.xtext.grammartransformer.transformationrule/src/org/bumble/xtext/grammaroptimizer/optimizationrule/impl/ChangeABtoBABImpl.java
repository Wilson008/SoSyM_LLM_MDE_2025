...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Change ABto BAB</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.ChangeABtoBABImpl#getAttrA <em>Attr A</em>}</li>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.ChangeABtoBABImpl#getAttrB <em>Attr B</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChangeABtoBABImpl extends OptimizationRuleImpl implements ChangeABtoBAB {
	/**
	...
	protected EClass eStaticClass() {
		return OptimizationrulePackage.Literals.CHANGE_ABTO_BAB;
	}
	...
	public void setAttrA(String newAttrA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimizationrulePackage.CHANGE_ABTO_BAB__ATTR_A, oldAttrA, attrA));
	}
	...
	public void setAttrB(String newAttrB) {
		...
		attrB = newAttrB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimizationrulePackage.CHANGE_ABTO_BAB__ATTR_B, oldAttrB, attrB));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OptimizationrulePackage.CHANGE_ABTO_BAB__ATTR_A:
				return getAttrA();
			case OptimizationrulePackage.CHANGE_ABTO_BAB__ATTR_B:
				return getAttrB();
		}
	...
	public void apply() {		
		for (GrammarRule rule : getGrammar().getRules()) {
			...
			String coreLineContentOfB = null;
			...
			for (LineEntry line : rule.getLines()) {
				...
				if (line.getAttrName().equals(attrB)) {
					...
					coreLineContentOfB = lineContent.stripLeading();
					break;
				}
			}
			
			if (coreLineContentOfB == null)
				break;
			...
			for (LineEntry line : rule.getLines()) {
				...
				if (line.getAttrName().equals(attrA)) {
					...
					String coreLineContentOfA = lineContent.stripLeading();
